...
public class ParabolicProjection : MonoBehaviour
{
    ...
    public void Shoot()
    {
        ...
        //  projectile.AddForce(transform.forward * force,ForceMode.VelocityChange);
      // projectile.AddForce(transform.forward * force);
    }
    ...
    private void Update()
    {
        ...
        {
            SimulatePath(transform.gameObject, hit.point, currentProjectilePrefab.drag);
        }
