...
//     version 1.7.0
//     from Assets/Repo/InputSystem/PlayerControls.inputactions
//
...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Fish"",
            ""id"": ""d948acba-6b9a-4daf-8bba-84d94abce0d5"",
            ""actions"": [
                {
                    ""name"": ""ThrowFishing"",
                    ""type"": ""Button"",
                    ""id"": ""a459ed13-a2ba-40a0-b8e9-97ed038721dc"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""655602e2-dee0-480f-b3c5-326245cf95f8"",
    ...
    ""controlSchemes"": []
        ...
        m_Fish_ThrowFishing = m_Fish.FindAction("ThrowFishing", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Fish_ThrowFishing;
    public struct FishActions
    {
        private @PlayerControls m_Wrapper;
        public FishActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
        public InputAction @ThrowFishing => m_Wrapper.m_Fish_ThrowFishing;
        ...
        public void AddCallbacks(IFishActions instance)
        {
            ...
            @ThrowFishing.started += instance.OnThrowFishing;
            @ThrowFishing.performed += instance.OnThrowFishing;
            @ThrowFishing.canceled += instance.OnThrowFishing;
        }
    ...
    {
        void OnThrowFishing(InputAction.CallbackContext context);
    }
}
